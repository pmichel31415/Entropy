...
void Store::create(queue<string> seq, long long int nb){}

long long int Store::get_hits(queue<string> seq){ return 0; }
void Store::add_hits(queue<string> seq, long long int nb){}
